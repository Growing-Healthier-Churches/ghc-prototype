...
?>
        ...
        <form class="sharelink-form" action="test-dashboard" method="get">
            <select name="share_id" class="dashboard-select">
                <!-- generated from JS -->
            </select>
				...
				<div class="timeline-content">
                    ...
                    <div class="timeline-content-inner">
                        ...
                        <div id="accountEmails" class="callout callout-info">
                            <p><span class="dashicons dashicons-info"></span>The following email accounts are associated to your my GHC team: emai1@test.com, email2@test.com</p>
                        </div>
